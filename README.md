...
│  AttackPattern · AStarPathfinder                             │
├──────────────────────────────────────────────────────────────┤
│  Presentation Layer                                          │
│  DungeonTilemapRenderer · DoorController                     │
│  EnemyHealthBar · SkillSlotUI · SkillUIManager               │
│  SkillRangePreviewer                                         │
└──────────────────────────────────────────────────────────────┘
```
...
### 10-2. 스킬 범위 미리보기 (SkillRangePreviewer)
...
| HP바 / MP바 UI | 높음 | CombatEventChannel 이벤트 구독으로 구현 |
