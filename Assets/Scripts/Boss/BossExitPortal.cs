...
public sealed class BossExitPortal : MonoBehaviour
{
    [Header("Visual")]
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        _isProceeding = true;
        if (_controller.RequestProceed(player))
        {
            _locked = true;
            return;
        }
    ...
    private void EnsureVisual()
    {
        ...
        if (!_warnedMissingVisual && _spriteRenderer.sprite == null)
        {
            ...
            Debug.LogWarning("[BossExitPortal] SpriteRenderer.sprite is missing. Assign a portal sprite on the prefab/scene object.", this);
        }
#endif
    }
    ...
    private void DisableFogVisibilityRendererIfPresent()
    {
        ...
        if (!_warnedFogVisibility)
        {
            ...
            Debug.LogWarning("[BossExitPortal] FogVisibilityRenderer was disabled so portal remains visible.", this);
        }
#endif
    }
}
